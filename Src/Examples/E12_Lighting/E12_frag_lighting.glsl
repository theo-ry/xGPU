...
void main() 
{
	...
	vec3 LightDirection = normalize( pushConsts.LocalSpaceLightPos.zyx - In.LocalSpacePosition );
	...
	outFragColor.rgb += pushConsts.LightColor.rgb * ( SpecularI2.rrr + DiffuseI.rrr * DiffuseColor.rgb );
