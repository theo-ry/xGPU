...
copy "..\dependencies\xgeom_compiler\dependencies\xraw3D\dependencies\assimp\build\x64\bin\Release\assimp-vc142-mt.dll" "xGPUExamples.vs2019\assimp-vc142-mt.dll" /Y
if %ERRORLEVEL% GEQ 1 goto :ERROR
